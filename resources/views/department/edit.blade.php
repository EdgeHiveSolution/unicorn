...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        ...
        <div class="">
            ...
            <a href="" onclick="event.preventDefault(); document.getElementById('update-form').submit();"
                class="btn btn-primary p-3">Save Changes</a>
        </div>
    </div>
    ...
    <form id="update-form" method="POST" action="/departments/{{ $department->id }}">
        ...
        <div class="row mb-2 p-3">
            ...
            <div class="col-md-5 offset-md-0 text-center">
                <input id="name" name="name"
                    class="form-control @error('name') is-invalid @enderror form-control-lg" type="text"
                    value="{{ $department->name }}" autocomplete="name" autofocus>
        ...
        <div class="row mb-2 p-3">
            ...
            <div class="col-md-5 offset-md-0 text-center">
                <input id="email" name="email"
                    class="form-control @error('email') is-invalid @enderror form-control-lg" type="email"
                    value="{{ $department->email }}" autocomplete="email" autofocus>
        ...
        <div class="row mb-2 p-3">
            <label for="about" class="col-md-3 col-form-label text-md-start">{{ __('About') }} <br><span
                    class="text-muted">Write a brief of the department.</span></label>
        ...
        <div class="row mb-2 p-3">
            <label for="members" class="col-md-3 col-form-label text-md-start">{{ __('Members') }} <br><span
                    class="text-muted">Invite or select the relevant members to this department</span></label>

            <div class="col-md-5 offset-md-0 text-center">
                <input id="members" name="members"
                    class="form-control @error('members') is-invalid @enderror form-control-lg" type="text"
                    value="{{ $department->members }}" autocomplete="members" autofocus>
                @error('members')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
