...
export default {
    ...
    getDepartmentName(departmentId) {
        ...
        const selectedDepartment = this.departments.find((department) => department.id === this.member.department_id);
        const selectedRole = this.member.role;

        this.selectedItems.push({
            memberEmail: selectedMemberEmail,
            departmentId: selectedDepartment ? selectedDepartment.name : "",
