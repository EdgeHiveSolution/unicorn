...
class DepartmentApiController extends Controller
{
        ...
        foreach ($members as $memberEmail) {
            ...
            if (!$existingMemberInDepartment) {
                ...
                if (!$existingMember) {
                    ...
                    // Also pass a non-deleted instance of Member
    ...
    {
        $departmentName = Department::where('name', $name)->first();
        return response()->json(['exists' => !!$departmentName]);
    }

    public function checkDepartmentEmail($email)
    {
        $departmentEmail = Department::where('email', $email)->first();
        return response()->json(['exists' => !!$departmentEmail]);
    }
