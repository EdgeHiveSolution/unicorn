...
Route::put('v1/partner-update/{id}', [PartnerApiController::class, 'update']);
...
Route::get('/check-name/{name}', [UserController::class, 'checkName']);
Route::get('/check-email/{email}', [UserController::class, 'checkEmail']);
Route::get('/check-phone/{phone}', [UserController::class, 'checkPhone']);


Route::get('/check-department-name/{name}', [DepartmentApiController::class, 'checkDepartmentName']);
Route::get('/check-department-email/{email}', [DepartmentApiController::class, 'checkDepartmentEmail']);
